      ...
      <div className='rounded border p-4'>
        ...
        {subscription ? (
          <>
            ...
            <div className='mt-4'>
              <button onClick={unsubscribeFromPush} className='rounded bg-red-500 px-4 py-2'>
                登録解除
              </button>
            </div>
          </>
          ...
          <div>
            ...
            <div className='mt-4'>
              <button onClick={subscribeToPush} className='rounded bg-green-500 px-4 py-2'>
                登録
              </button>
            </div>
          </div>
        ...
        {error && <p className='mt-4 rounded bg-red-50 p-2 text-red-500'>{error}</p>}
      </div>
    </div>
  )
}
